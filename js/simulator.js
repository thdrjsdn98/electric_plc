...
const LEFT_POWER_REAL_FLOW = [
  ...
  {id:'lp-l3-src', state:'sourcePower', points:[[227,255],[227,307],[227,337],[227,426]]},
  ...
  {id:'lp-l3-pre', state:'sourcePower', points:[[227,426],[227,480],[227,568]]},

  // FUSE 상/하단 제어전원 : MCCB ON 상태에서 항상 통전
  // 상단 FUSE -> 제어회로 상단 전원
  {id:'lp-fuse-top-in', state:'fusePower', points:[[145,373],[331,373]]},
  {id:'lp-fuse-top-out', state:'fusePower', points:[[372,373],[511,373],[511,292],[593,292]]},
  // 하단 FUSE -> 제어회로 하단 공통선
  {id:'lp-fuse-bot-in', state:'fusePower', points:[[227,404],[331,404]]},
  ...
  {id:'lp-mc1-l3', state:'mc1Power', points:[[227,568],[227,608],[227,738],[227,774]]},

  // MC2 역회전 입력 교차배선 -> 실제 MC2 주접점 상단(원본 검은선 실측)
  // PE(267)는 상선이 아니므로 MC2 3상에서 제외한다.
  {id:'lp-mc2-feed1', state:'sourcePower', points:[[145,547],[348,547],[348,568],[348,608]]},
  {id:'lp-mc2-feed2', state:'sourcePower', points:[[186,526],[389,526],[389,568],[389,608]]},
  {id:'lp-mc2-feed3', state:'sourcePower', points:[[227,506],[430,506],[430,568],[430,608]]},
